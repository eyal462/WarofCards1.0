  ...
  for i in range (10):
   #   """create 10 rounds of War of Cards"""
    ...
    if card1.__gt__(card2):
        ...
        points1 +=1
        print(f"PLAYER 1 ({CardGame1.player1.name}) IS THE WINNER (Points: {CardGame1.player1.name} {points1}:{points2} {CardGame1.player2.name})\n")
    if card2.__gt__(card1):
        ...
        print(f"{CardGame1.player2.name}'s: {card2.__repr__()}")
        points2 += 1
        print(f"PLAYER 2 ({CardGame1.player2.name}) IS THE WINNER (Points: {CardGame1.player1.name} {points1}:{points2} {CardGame1.player2.name})\n")
    else:
        print("============TIE================\n")
  print("================END OF GAME ======================")
