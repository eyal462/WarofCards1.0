...
if __name__ == '__main__':
    """THE MAIN GAME"""
  player1=Player("eyal",num_of_cards=26)
  player2=Player("lior",num_of_cards=26)
  points1 = 0
  points2 = 0
  ...
  for i in range (10):
    ...
    if card1.__gt__(card2):
        ...
        points1 +=1
        print(f"PLAYER 1 ({player1.name})(Points: {player1.name} {points1}:{points2} {player2.name}) IS THE WINNER")
    if card2.__gt__(card1):
        ...
        print(f"{player2.name}'s: {card2.__repr__()}")
        points2 += 1
        print(f"PLAYER 2 ({player2.name})(Points: {player1.name} {points1}:{points2} {player2.name}) IS THE WINNER")
  print("================END MATCH======================")
  if points1 > points2:
